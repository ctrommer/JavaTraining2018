 ...
 * 
 * Rechte Maus | Debug As | Debug Configurations... | Java Application | 
 * AssertDemo | Arguments | VM Arguments: | -ea eintragen | Apply
 * 
 * Die Application muss einmal gelaufen sein, damit unter
 * Java Application ueberhaupt Assertions erscheinen.
 *    
 */
