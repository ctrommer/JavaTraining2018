...
public class KircheZusammenbastlerModul extends AbstractModule {
	...
	protected void configure() {
		bind(SingletonAufKlassenebene.class).to(SingletonAufKlassenebeneImpl.class);
		bind(SingletonAufKonfigurationsEbene.class).to(SingletonAufKonfigurationsEbeneImpl.class).in(Singleton.class);
	}
