...
/**
 * Ein in der Praxis sinnvolles Beispiel für den Director habe ich nicht gefunden.
 ...
 * hier das Java Codebeispiel für den Director anschauen:
 * https://refactoring.guru/design-patterns/builder/java/example#example-0--Demo-java
 * 
 * ( 2 )
 * Erich Gamma ...
 * Der Director wird zwar bei Erich Gamma erwähnt, aber nicht im Codebeispiel.
